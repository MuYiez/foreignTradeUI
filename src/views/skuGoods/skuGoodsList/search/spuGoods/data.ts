...
export const innerColumns: ColumnProps[] = [
  {
    title: '图片',
  ...
  },
  {
    ...
    slots: { title: '参考价(￥)', customRender: 'purchase_ref_price' },
  },
  {
    title: '重量（g）',
    dataIndex: 'weight',
...
export const columns: ColumnProps[] = [
  ...
  },
  {
    ...
    dataIndex: 'purchase_ref_price',
    key: 'purchase_ref_price',
    slots: { title: '参考价(￥)', customRender: 'size' },
  },
  {
    title: '重量（g）',
    dataIndex: 'weight',
    key: 'weight',
    slots: { title: '重量（g）', customRender: 'size' },
  },
  {
    title: '尺寸（cm）',
    slots: { title: '尺寸（cm）', customRender: 'size' },
  ...
  {
    title: '状态',
    slots: { title: '状态', customRender: 'size' },
  },
  {
    title: '时间',
    slots: { title: '时间', customRender: 'time' },
